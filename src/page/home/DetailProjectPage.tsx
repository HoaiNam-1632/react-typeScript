...
const AssignPosition = ({ position }: Props) => {
    return (
                ...
                <div className="flex">
                    <div className="w-[90%] mx-2 ">
                        ...
                        <div className="flex relative  py-2">
                            <h2 className="text-[#0C4A6E] text-[25px] ">SOFT WARE ENGINEER</h2>
                        ...
                        <div className="flex  border-t-2 ">
                            ...
                            <div className="flex mr-[10%] space-x-3">
                                ...
                                <div className="m-auto grid grid-cols-7 grid-flow-row gap-8 py-1">
                                    <AssignPosition position={'Leader'} />
                                    <AssignPosition position={'Dev'} />
                                    <AssignPosition position={'BE'} />
                                    <AssignPosition position={'QA'} />
                                    <AssignPosition position={'FE'} />
                                    <AssignPosition position={'Tester'} />
                                    <AssignPosition position={'PM'} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border-t-[1px]">
                            <table className="w-full">
                                <ListInfo title={'Main author name'} content={'Tom Cook'}>
                                    <td className="pl-[8px]">
                                        <h2 className="mx-auto ">tomcook.admin.01@gmail.com</h2>
                                        <h2 className="mx-auto py-2">0909 888 000 </h2>
                                    </td>
                                </ListInfo>
                                ...
                                <ListInfo title={'Category'} content={'Mobile App'} />
                                <ListInfo title={'Salary'} content={'$120,000'} />
                                <ListInfo title={'Tuition'} content={'$100'} />
                                ...
                                <ListInfo title={'Main description'} content={`Fugiat ipsum ipsum deserunt
                                ...
                                <ListInfo title={'Attachments'}>
                                    <td className="py-20" colSpan={2}>
                                        <div className="border-2 -translate-x-[8em] rounded-lg ">
                                            <Attachments title={'PitchDeck.pdf'} />
                                            <Attachments title={'Description.doc'} />
                                            <Attachments title={'Description.mp4'} />
                                        </div>
                                    </td>
                                </ListInfo>
                            </table>
